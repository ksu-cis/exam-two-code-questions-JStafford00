...
namespace ExamTwoCodeQuestions.DataTests
{
    public class CobblerUnitTests
    {
        ...
        [Fact]
        public void ChangingFruitPropertyShouldInvokePropertyChangeForFruit()
        {
            var cobbler = new Cobbler();
        ...
        [Fact]
        public void ChangingSpecialInstructionsProperyShouldInvokePropertyChangedForSpecialInstructions()
        {
            var cobbler = new Cobbler();
